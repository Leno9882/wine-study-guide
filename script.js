const wineMenu = {
    "Sparkling": [
        { id: "001", name: "Prosecco, Avissi", region: "Veneto, Italy", year: "NV", price: 12, classification: "DOC Prosecco", method: "Charmat Method", climate: "Mild Continental", altitude: "250m", soil: "Clay & Marl", coords: [45.84, 12.12], pitch: "Extra-dry and ultra-clean; white flowers and green apple.", pairings: ["Tuna Tartare", "Shrimp Cocktail"], vitals: { grapes: "Glera", composition: ["100% Glera"], palate: "Green Apple, Honeysuckle, Pear", chartData: [2, 4, 1, 2, 1] } },
        { id: "002", name: "Crémant de Loire, Gratien & Meyer", region: "Loire, France", year: "NV", price: 15, classification: "AOC Crémant", method: "Traditional Method", climate: "Cool Maritime", altitude: "100m", soil: "Tuffeau (Limestone)", coords: [47.25, -0.07], pitch: "Creamy, brioche-like weight from extended aging in limestone caves.", pairings: ["Jumbo Lump Crab Cake", "Octopus"], vitals: { grapes: "Chardonnay / Chenin Blanc", composition: ["40% Chardonnay", "40% Chenin Blanc", "20% Cabernet Franc"], palate: "Lemon Zest, Almond, Baked Apple", chartData: [3, 4, 1, 3, 2] } },
        { id: "003", name: "Champagne, Taittinger", region: "Reims, France", year: "NV", price: 25, classification: "AOC Champagne", method: "Méthode Champenoise", climate: "Cool Continental", altitude: "150m", soil: "Belemnite Chalk", coords: [49.25, 4.03], pitch: "Elegant with a persistent, lacy mousse and honeyed finish.", pairings: ["Oysters", "Cavatelli with Lobster"], vitals: { grapes: "Chard / Pinot Noir", composition: ["40% Chardonnay", "35% Pinot Noir", "25% Pinot Meunier"], palate: "Brioche, Honey, White Peach", chartData: [3, 5, 1, 3, 2] } },
    ...
    "Whites": [
        { id: "036", name: "Sauvignon Blanc, Sancerre", region: "Loire, France", year: "2024", price: 21, classification: "AOC Sancerre", method: "Stainless Steel", climate: "Cool Continental", altitude: "280m", soil: "Silex/Flint", coords: [47.33, 2.83], pitch: "Bone-dry and electric; defined by smoky flint minerality.", pairings: ["Oysters", "Branzino"], vitals: { grapes: "Sauvignon Blanc", composition: ["100% Sauvignon Blanc"], palate: "Grapefruit, Gunflint, Lemongrass", chartData: [2, 5, 1, 3, 1] } },
        { id: "022", name: "Sauvignon Blanc, Echo Bay", region: "Marlborough, NZ", year: "2024", price: 13, classification: "Marlborough AVA", method: "Stainless Steel", climate: "Maritime", altitude: "50m", soil: "Stony Loam", coords: [-41.51, 173.96], pitch: "Tropical explosion of passionfruit and lime.", pairings: ["Tuna Tartare", "Crispy Skin Salmon"], vitals: { grapes: "Sauvignon Blanc", composition: ["100% Sauvignon Blanc"], palate: "Passionfruit, Guava, Key Lime", chartData: [2, 5, 1, 3, 1] } },
        { id: "023", name: "Pinot Grigio, Hofstatter", region: "Alto Adige, Italy", year: "2023", price: 17, classification: "DOC Alto Adige", method: "Stainless Steel", climate: "Alpine/Continental", altitude: "450m", soil: "Gravel/Porphyry", coords: [46.33, 11.30], pitch: "Alpine-grown; crisp saline bite and fresh pear.", pairings: ["Branzino", "Octopus"], vitals: { grapes: "Pinot Grigio", composition: ["100% Pinot Grigio"], palate: "Bartlett Pear, Saline, White Pepper", chartData: [2, 5, 1, 3, 1] } },
        { id: "025", name: "Chardonnay, Neyers 304", region: "Sonoma, CA", year: "2023", price: 18, classification: "Sonoma County AVA", method: "Unoaked (Steel)", climate: "Cool Maritime", altitude: "100m", soil: "Gravelly Loam", coords: [38.29, -122.45], pitch: "Un-oaked and pure; bright tropical pineapple fruit.", pairings: ["Jumbo Lump Crab Cake", "Roasted Chicken"], vitals: { grapes: "Chardonnay", composition: ["100% Chardonnay"], palate: "Pineapple, Starfruit, Lemon Curd", chartData: [3, 4, 1, 4, 1] } },
        { id: "203", name: "Chardonnay, Flowers", region: "Sonoma Coast, CA", year: "2023", price: 35, classification: "Sonoma Coast AVA", method: "French Oak Aged", climate: "Cool Maritime/Foggy", altitude: "400m", soil: "Schist", coords: [38.54, -123.21], pitch: "Coastal acidity meets elegant oak and sea-salt.", pairings: ["Cavatelli with Lobster", "Branzino"], vitals: { grapes: "Chardonnay", composition: ["100% Chardonnay"], palate: "Meyer Lemon, Sea Salt, Roasted Pear", chartData: [4, 4, 1, 4, 3] } },
        { id: "034", name: "Chardonnay, Wm. Fevre", region: "Chablis, France", year: "2023", price: 22, classification: "AOC Chablis", method: "Stainless Steel/Oak", climate: "Cool Continental", altitude: "200m", soil: "Kimmeridgian", coords: [47.81, 3.80], pitch: "Lean acidity with a crushed-seashell finish.", pairings: ["Oysters", "Shrimp Cocktail"], vitals: { grapes: "Chardonnay", composition: ["100% Chardonnay"], palate: "Chalk, Green Apple, Lemon Peel", chartData: [3, 5, 1, 3, 1] } }
    ],
    "Red": [
